...
public:
	...
	virtual wsql::ResultSet::enum_type getResultSetType() = 0;

	virtual uint64_t getUpdateCount() = 0;

	virtual const SQLWarning * getWarnings() = 0;

	virtual void setCursorName(const wsql::SQLString & name) = 0;
	...
	virtual Statement * setResultSetType(wsql::ResultSet::enum_type type) = 0;
};
