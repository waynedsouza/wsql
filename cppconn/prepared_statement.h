...
public:
	...
	virtual bool execute(const wsql::SQLString& sql) = 0;
	virtual bool execute() = 0;

	virtual ResultSet *executeQuery(const wsql::SQLString& sql) = 0;
	virtual ResultSet *executeQuery() = 0;

	virtual int executeUpdate(const wsql::SQLString& sql) = 0;
	...
	virtual void setBigInt(unsigned int parameterIndex, const wsql::SQLString& value) = 0;

	virtual void setBlob(unsigned int parameterIndex, std::istream * blob) = 0;

	virtual void setBoolean(unsigned int parameterIndex, bool value) = 0;

	virtual void setDateTime(unsigned int parameterIndex, const wsql::SQLString& value) = 0;
	...
	virtual void setString(unsigned int parameterIndex, const wsql::SQLString& value) = 0;

	virtual PreparedStatement * setResultSetType(wsql::ResultSet::enum_type type) = 0;
};
